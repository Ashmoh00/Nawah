...
const translations = {
  ...
  ar: {
    ...
    // Home — Hero
    hero_eyebrow: "في عمق التقنية",
    hero_title: "ذكاء اصطناعي كفء للأجهزة الذكية والأنظمة المستقلة في العالم الحقيقي.",
    hero_text: "نواة تبني أنظمة ذكاء اصطناعي طرفية تعمل بطاقة منخفضة وأداء لحظي — من نماذج الذكاء الاصطناعي المُحسَّنة إلى عتاد مخصص.",
    ...
    intro_text: "نعمل على نماذج الذكاء الاصطناعي والعتاد والأنظمة المدمجة — لتقديم ذكاء اصطناعي جاهز للنشر الفعلي.",

    // Home — Metrics
    metrics_1_t: "كفاءة في الطاقة",
    metrics_1_d: "قرارات هندسية تضع الكفاءة أولاً",
    metrics_2_t: "أداء لحظي",
    metrics_2_d: "استجابة فورية حيث يهم وقت الاستجابة",
    ...
    pillars_text: "نغطي المسار كاملاً من نماذج الذكاء الاصطناعي إلى العتاد إلى تكامل الأنظمة، لبناء حلول طرفية جاهزة للإنتاج.",
    pillar_1_t: "نماذج الذكاء الاصطناعي",
    pillar_1_d: "نبني نماذج ذكاء اصطناعي للرؤية الحاسوبية، واكتشاف الأعطال، ومعالجة اللغة، والتنبؤ، والذكاء التوليدي — مصممة للنشر الفعلي.",
    pillar_2_t: "تسريع الذكاء الاصطناعي",
    pillar_2_d: "نُحسّن أداء نماذج الذكاء الاصطناعي على العتاد المستهدف للوصول لأفضل توازن بين السرعة والاستهلاك.",
    ...
    pillar_4_d: "أبحاث في معماريات حوسبة كفؤة للجيل القادم من الأنظمة المستقلة.",
    ...
    edge_text: "الذكاء الاصطناعي الطرفي يعالج البيانات على الجهاز مباشرة — استجابة أسرع، استهلاك أقل، وأداء ثابت.",
    ...
    edge_2_d: "استهلاك أقل يعني تكاليف أقل وعمر بطارية أطول للأجهزة الذكية.",
    ...
    step_2_d: "نختار النموذج والعتاد واستراتيجية التسريع في خطوة واحدة.",
    ...
    solutions_text: "نواة تغطي الذكاء الاصطناعي والعتاد والحوسبة المتقدمة — من الفكرة حتى النشر.",
    ...
    cta_text: "تواصل معنا لبناء أنظمة ذكاء اصطناعي كفؤة، مصممة للعمل الفعلي لا للعرض فقط.",
    cta_btn1: "تواصل معنا",
    ...
    about_hero_text: "نواة شركة سعودية تبني أنظمة ذكاء اصطناعي طرفية كفؤة للتطبيقات ذاتية التشغيل والمدمجة، في إطار رؤية 2030.",
    ...
    about_who_p1: "نواة شركة سعودية تعمل على الذكاء الاصطناعي الطرفي وأنظمة الحوسبة المستلهَمة من الدماغ، بتركيز على كفاءة الأداء في البيئات الواقعية.",
    about_who_p2: "هدفنا بعيد المدى هو تطوير شرائح ذكاء اصطناعي سعودية مستلهَمة من الدماغ. حالياً نبني أنظمة ذكاء اصطناعي طرفي عالية الجودة مع شركاء مختارين.",
    ...
    about_vision_text: "نسعى لأن تكون المملكة رائدة في الذكاء الاصطناعي الطرفي والحوسبة المستلهَمة من الدماغ، بما يخدم رؤية 2030 ومبادرات سداية وسدايا.",
    about_mission_eyebrow: "الرسالة",
    about_mission_title: "تصميم حوسبة فائقة الكفاءة للجيل القادم",
    about_mission_text: "نبني أنظمة حوسبة كفؤة تقدم ذكاء اصطناعي لحظي للجيل القادم من الأجهزة الطرفية.",
    ...
    about_feat_2_d: "نصمم مع أخذ زمن الاستجابة والطاقة والموثوقية بعين الاعتبار من البداية.",
    about_feat_3_t: "يستند إلى البحث",
    about_feat_3_d: "توجهنا مبني على بحث عميق في نماذج الحوسبة المتقدمة.",
    ...
    about_cta_text: "تواصل معنا لاستكشاف كيف نبني معك أنظمة ذكاء اصطناعي تعمل فعلاً على أرض الواقع.",
    ...
    sol_2_li_1: "تكامل المستشعرات وخطوط معالجة البيانات",
